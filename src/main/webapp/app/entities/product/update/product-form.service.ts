 ...
 */
type FormValueOf<T extends IProduct | NewProduct> = Omit<T, 'expirationDate' | 'createdAt'> & {
...
type ProductFormDefaults = Pick<NewProduct, 'id' | 'expirationDate' | 'createdAt'>;
...
type ProductFormGroupContent = {
  ...
  expirationDate: FormControl<ProductFormRawValue['expirationDate']>;
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      expirationDate: new FormControl(productRawValue.expirationDate),
  ...
  private convertProductRawValueToProduct(rawProduct: ProductFormRawValue | NewProductFormRawValue): IProduct | NewProduct {
    return {
      ...rawProduct,
      expirationDate: dayjs(rawProduct.expirationDate, DATE_TIME_FORMAT),
  ...
  private convertProductToProductRawValue(
    ...
    return {
      ...product,
      expirationDate: product.expirationDate ? product.expirationDate.format(DATE_TIME_FORMAT) : undefined,
