...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'monthly', barcode: 'smug brr exactly' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('pfft');
      cy.get(`[data-cy="name"]`).should('have.value', 'pfft');

      cy.get(`[data-cy="price"]`).type('15637.99');
      cy.get(`[data-cy="price"]`).should('have.value', '15637.99');

      cy.get(`[data-cy="stock"]`).type('6240');
      cy.get(`[data-cy="stock"]`).should('have.value', '6240');

      cy.get(`[data-cy="barcode"]`).type('amidst');
      cy.get(`[data-cy="barcode"]`).should('have.value', 'amidst');

      cy.get(`[data-cy="expirationDate"]`).type('2025-07-14T04:11');
      cy.get(`[data-cy="expirationDate"]`).blur();
      cy.get(`[data-cy="expirationDate"]`).should('have.value', '2025-07-14T04:11');

      cy.get(`[data-cy="createdAt"]`).type('2025-07-14T19:51');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2025-07-14T19:51');
