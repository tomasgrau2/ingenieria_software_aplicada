...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9bf1b7cf-9ee6-4d06-a484-a72797e965d8' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('86cb307b-c697-409b-8678-717b04af7e8e');
      cy.get(`[data-cy="name"]`).should('have.value', '86cb307b-c697-409b-8678-717b04af7e8e');
